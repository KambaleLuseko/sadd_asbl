...
class SearchableTextFormFieldWidgetToJSON extends StatefulWidget {
  final String hintText;
  final Color textColor;
  final Color backColor;
  final Color? overlayColor;
  ...
  SearchableTextFormFieldWidgetToJSON({
    super.key,
    required this.hintText,
    required this.textColor,
    required this.backColor,
  ...
  @override
  State<SearchableTextFormFieldWidgetToJSON> createState() =>
      _SearchableTextFormFieldWidgetToJSONState();
}

class _SearchableTextFormFieldWidgetToJSONState
    extends State<SearchableTextFormFieldWidgetToJSON> {
  List searchedData = [];
  final layerLink = LayerLink();
  final focusNode = FocusNode();
